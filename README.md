# Tibber Price Information & Ratings Helper
...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/jpawlowski/tibber_prices_helper?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=tibber_prices_helper&category=integration)
...
1. Download the `custom_components/tibber_prices_helper/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=tibber_prices_helper)
...
3. Search for "Tibber Price Information Integration blueprint Ratings Helper"
...
1. Go to **Settings** → **Devices & Services**
2. Find **Tibber Price Information Integration Blueprint Ratings Helper**
...
Find all entities in **Settings** → **Devices & Services** → **Tibber Price Information Integration Blueprint Ratings Helper** → click on the device.
...
### `tibber_prices_helper.example_action`
...
```yaml
service: tibber_prices_helper.example_action
data:
  # Add your parameters here
```

### `tibber_prices_helper.reload_data`
...
```yaml
service: tibber_prices_helper.reload_data
```
...
logger:
  default: info
  logs:
    custom_components.tibber_prices_helper: debug
```
...
4. Check the integration diagnostics (Settings → Devices & Services → Tibber Price Information Integration blueprint Ratings Helper → 3 dots → Download diagnostics)
...
[commits-shield]: https://img.shields.io/github/commit-activity/y/jpawlowski/tibber_prices_helper.svg?style=for-the-badge
[commits]: https://github.com/jpawlowski/tibber_prices_helper/commits/main
[hacs]: https://github.com/hacs/integration
[hacsbadge]: https://img.shields.io/badge/HACS-Default-orange.svg?style=for-the-badge
[license-shield]: https://img.shields.io/github/license/jpawlowski/tibber_prices_helper.svg?style=for-the-badge
[maintenance-shield]: https://img.shields.io/badge/maintainer-%40jpawlowski-blue.svg?style=for-the-badge
[releases-shield]: https://img.shields.io/github/release/jpawlowski/tibber_prices_helper.svg?style=for-the-badge
[releases]: https://github.com/jpawlowski/tibber_prices_helper/releases
