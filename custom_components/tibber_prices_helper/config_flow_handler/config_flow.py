"""
Config flow for tibber_prices_helper.
...
from custom_components.tibber_prices_helper.config_flow_handler.schemas import (
    get_reauth_schema,
    get_reconfigure_schema,
    get_user_schema,
)
from custom_components.tibber_prices_helper.config_flow_handler.validators import validate_credentials
from custom_components.tibber_prices_helper.const import DOMAIN, LOGGER
from homeassistant import config_entries
from homeassistant.const import CONF_PASSWORD, CONF_USERNAME

if TYPE_CHECKING:
    from custom_components.tibber_prices_helper.config_flow_handler.options_flow import TibberPricesHelperOptionsFlow

# Map exception types to error keys for user-facing messages
ERROR_MAP = {
    "TibberPricesHelperApiClientAuthenticationError": "auth",
    "TibberPricesHelperApiClientCommunicationError": "connection",
}


class TibberPricesHelperConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """
    Handle a config flow for tibber_prices_helper.
    ...
    def async_get_options_flow(
        ...
        """
        from custom_components.tibber_prices_helper.config_flow_handler.options_flow import (  # noqa: PLC0415
            TibberPricesHelperOptionsFlow,
        )

        return TibberPricesHelperOptionsFlow()
...
__all__ = ["TibberPricesHelperConfigFlowHandler"]
