...
from custom_components.tibber_prices_helper.api import TibberPricesHelperApiClient
...
async def validate_credentials(hass: HomeAssistant, username: str, password: str) -> None:
    ...
    Raises:
        TibberPricesHelperApiClientAuthenticationError: If credentials are invalid.
