"""Device info utilities for tibber_prices_helper."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "Tibber Price Information Integration Blueprint Ratings Helper",
        manufacturer=manufacturer or "Tibber Price Information Integration Blueprint Ratings Helper",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('tibber_prices_helper', 'entry_id_value')}
    """
