"""
Base entity class for tibber_prices_helper.
...
from custom_components.tibber_prices_helper.const import ATTRIBUTION
...
class TibberPricesHelperEntity(CoordinatorEntity[TibberPricesHelperDataUpdateCoordinator]):
    """
    Base entity class for tibber_prices_helper.
