"""
Core DataUpdateCoordinator implementation for tibber_prices_helper.
...
from custom_components.tibber_prices_helper.api import (
...
class TibberPricesHelperDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    config_entry: TibberPricesHelperConfigEntry
    ...
    async def _async_update_data(self) -> Any:
        ...
        except TibberPricesHelperApiClientAuthenticationError as exception:
