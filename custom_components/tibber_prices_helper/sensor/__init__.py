"""Sensor platform for tibber_prices_helper."""
...
from .air_quality import ENTITY_DESCRIPTIONS as AIR_QUALITY_DESCRIPTIONS, TibberPricesHelperAirQualitySensor
from .diagnostic import ENTITY_DESCRIPTIONS as DIAGNOSTIC_DESCRIPTIONS, TibberPricesHelperDiagnosticSensor
...
async def async_setup_entry(
    ...
    async_add_entities(
        TibberPricesHelperAirQualitySensor(
    ...
    async_add_entities(
        TibberPricesHelperDiagnosticSensor(
            coordinator=entry.runtime_data.coordinator,
            entity_description=entity_description,
        )
