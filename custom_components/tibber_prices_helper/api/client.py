"""
API Client for tibber_prices_helper.
...
class TibberPricesHelperApiClientError(Exception):
    """Base exception to indicate a general API error."""


class TibberPricesHelperApiClientCommunicationError(
    TibberPricesHelperApiClientError,
):
    """Exception to indicate a communication error with the API."""


class TibberPricesHelperApiClientAuthenticationError(
    TibberPricesHelperApiClientError,
):
...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        TibberPricesHelperApiClientAuthenticationError: For 401/403 errors.
        aiohttp.ClientResponseError: For other HTTP errors.

    """
    if response.status in (401, 403):
        msg = "Invalid credentials"
        raise TibberPricesHelperApiClientAuthenticationError(
            msg,
        )
    response.raise_for_status()


class TibberPricesHelperApiClient:
    """
    ...
    async def async_get_data(self) -> Any:
        ...
        Raises:
            TibberPricesHelperApiClientAuthenticationError: If authentication fails.
            TibberPricesHelperApiClientCommunicationError: If communication fails.
            TibberPricesHelperApiClientError: For other API errors.
    ...
    async def _api_wrapper(
        ...
        try:
            ...
            raise TibberPricesHelperApiClientCommunicationError(
                msg,
            ) from exception
            ...
            raise TibberPricesHelperApiClientError(
                msg,
            ) from exception
