"""
Custom integration to integrate tibber_prices_helper with Home Assistant.
...
https://github.com/jpawlowski/tibber_prices_helper
...
from .data import TibberPricesHelperData
from .service_actions import async_setup_services

if TYPE_CHECKING:
    from homeassistant.core import HomeAssistant

    from .data import TibberPricesHelperConfigEntry
...
async def async_setup_entry(
    ...
    # Store runtime data
    entry.runtime_data = TibberPricesHelperData(
        client=client,
