# Getting Started with Tibber Price Information Integration Blueprint Ratings Helper

This guide will help you install and set up the Tibber Price Information Integration Blueprint Ratings Helper custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/jpawlowski/tibber_prices_helper`
6. Set category to "Integration"
7. Click "Add"
8. Find "Tibber Price Information Integration Blueprint Ratings Helper" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/jpawlowski/tibber_prices_helper/releases)
2. Extract the `tibber_prices_helper` folder from the archive
3. Copy it to `custom_components/tibber_prices_helper/` in your Home Assistant configuration directory
...
4. Select entities from "Tibber Price Information Integration Blueprint Ratings Helper"

Example entities card:

```yaml
type: entities
title: Tibber Price Information Integration Blueprint Ratings Helper
entities:
...
- Report issues at [GitHub Issues](https://github.com/jpawlowski/tibber_prices_helper/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/jpawlowski/tibber_prices_helper/discussions)
