...
- Create new sensor file in `custom_components/tibber_prices_helper/sensor/`
- Inherit from `TibberPricesHelperEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Tibber Price Information Integration Blueprint Ratings Helper."""
...
class TibberPricesHelper[SensorName]Sensor(
...
- Entity: `custom_components/tibber_prices_helper/sensor/[sensor_name].py`
- Platform: `custom_components/tibber_prices_helper/sensor/__init__.py`
- Translations: `custom_components/tibber_prices_helper/translations/*.json`
