...
**File:** `custom_components/tibber_prices_helper/services.yaml`
...
[action_name]:
  ...
  target:
    entity:
      ...
      # OR
      integration: tibber_prices_helper
...
Create `custom_components/tibber_prices_helper/service_actions/[action_name].py`:

```python
"""[Action name] service action for Tibber Price Information Integration Blueprint Ratings Helper."""
...
**File:** `custom_components/tibber_prices_helper/__init__.py`
...
**File:** `custom_components/tibber_prices_helper/const.py`
...
3. Find service action: `tibber_prices_helper.[action_name]`
...
- **Service actions directory:** `custom_components/tibber_prices_helper/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/tibber_prices_helper/services.yaml` (legacy filename)
- **Icons:** `custom_components/tibber_prices_helper/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/tibber_prices_helper/translations/*.json` under `services` key (legacy)
