...
- Inherit from `TibberPricesHelperEntity` and platform base class
...
- Entity: `custom_components/tibber_prices_helper/[platform]/[entity_name].py`
- Platform: `custom_components/tibber_prices_helper/[platform]/__init__.py`
