...
- `entity/` - Base entity class (`TibberPricesHelperEntity`)
...
- All entities inherit: `(PlatformEntity, TibberPricesHelperEntity)` - order matters for MRO
...
- Adjust log level: `custom_components.tibber_prices_helper: debug` in `config/configuration.yaml`
