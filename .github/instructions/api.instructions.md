...
- `TibberPricesHelperApiClientError` (Base)
- `TibberPricesHelperApiClientCommunicationError` (Network, timeout, HTTP errors)
- `TibberPricesHelperApiClientAuthenticationError` (401, 403, invalid credentials)
