...
- **`entity/`** - Base entity classes (inherit `TibberPricesHelperEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, TibberPricesHelperEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import TibberPricesHelperEntity`
